...
export default function MeetingDetailsPage({ params }: { params: { id: string } }) {
      ...
      try {
        ...
        if (!response.ok) {
          if (response.status === 404) {
            ...
            router.push("/login?callbackUrl=/collaborations/meetings/" + params.id)
            return
          } else {
  ...
  if (!meeting) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="text-gray-500 text-xl mb-4">Meeting not found</div>
        <Button
          asChild
          variant="outline"
          className="group rounded-full px-8 border-[#1B3668] text-[#1B3668] hover:bg-[#1B3668] hover:text-white transition-all duration-200"
    ...
    <div className="min-h-screen bg-[#F9FAFB]">
      <header className="bg-gradient-to-r from-[#1B3668] to-[#0A2240] shadow-md relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 relative">
          ...
          <p className="text-blue-100 mt-2 max-w-2xl">View details for the scheduled meeting</p>
        </div>
      </header>
            ...
            <CardContent className="p-6">
              {meeting.documentType === "image" ? (
                ...
                <div className="aspect-[16/9] w-full rounded-lg border border-gray-200">
                  <iframe
                    src={`${meeting.documentUrl}#toolbar=0`}
          ...
          <Card className="border-[#E5E7EB] bg-white shadow-sm mb-8">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="prose max-w-none">
                ...
                <p className="text-[#4B5563]">{meeting.description}</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#1F2937] font-medium">{meeting.time}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#1F2937] font-medium">{meeting.location}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#1F2937] font-medium">{meeting.organizer.firstName}</p>
                  </div>
                </div>
              </div>
            </CardContent>
